      ...
      <div className="login">
        <div className="card-auth">
          <form onSubmit={(e) => handleLogin(e)}>
            ...
            <i className={passwordIsVisible ? 'password-is-visible-login far fa-eye-slash' : 'password-is-visible-login fa fa-eye'} onClick={() => setPasswordIsVisible(!passwordIsVisible)} />
